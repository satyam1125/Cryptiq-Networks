  ...
  const projects = [
    {
      ...
      title: "Triloki Group",
      description: "A Chardham travel booking application with customizable itineraries. Dynamic website built with Next.js, featuring a dedicated admin dashboard for managing bookings, itineraries and customer data.",
      category: "Travel Booking (Chardham)",
      technologies: ["Next.js", "Tailwind CSS", "Dynamic Itineraries"],
      link: "https://trilokigroup.com",
    },
    {
      name: "mahiraoverseas.com",
      title: "Mahira Overseas",
      description: "An import-export business platform developed with Next.js and a dedicated dashboard for order and shipment management. We also designed their branding assets including logo and promotional banners.",
